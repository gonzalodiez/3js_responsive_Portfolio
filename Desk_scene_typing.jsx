...
Command: npx gltfjsx@6.2.14 .\public\models\desk_scene_typing.gltf -K -k 
*/
...
export function Office(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/desk_scene_typing.gltf')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Empty" position={[-0.2, 0.05, -0.56]} rotation={[-Math.PI, 0.612, -Math.PI]} scale={1.272}>
          <group name="Armature">
        ...
        <group name="keyboard" position={[0.076, 0.981, -1.316]} rotation={[0, -0.338, 0]} scale={0.89}>
        ...
        <mesh name="Comp_Mouse" geometry={nodes.Comp_Mouse.geometry} material={materials['lambert3SG.003']} position={[-0.11, 0, 0.06]} />
        ...
        <group name="Chair" position={[-0.168, 0, -0.538]} rotation={[0, -0.376, 0]}>
...
useGLTF.preload('/desk_scene_typing.gltf')
